          ...
          <div className="prose-content space-y-8 font-body text-foreground/85 leading-relaxed">
            ...
            <section>
              ...
              <ul className="space-y-1.5 list-disc pl-5">
                ...
                <li><strong>Dados de navegação:</strong> endereço IP, identificadores de dispositivo, tipo de navegador, sistema operacional, páginas visitadas, tempo de permanência, origem do acesso (referrer), termos de busca e cookies, coletados via Google Tag Manager para fins estatísticos e de melhoria do site.</li>
              </ul>
            </section>
