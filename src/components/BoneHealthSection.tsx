    ...
    <section className="py-20 bg-navy-light">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center font-body text-foreground/60 max-w-2xl mx-auto mb-14">
          Atuamos na prevenção, diagnóstico e tratamento de condições que afetam a qualidade óssea e muscular, aumentando o risco de quedas, fraturas e mortalidade.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="bg-background/50 border border-border rounded-xl p-8">
            ...
            <p className="font-body text-foreground/65 leading-relaxed text-sm">
              Doença esquelética sistêmica caracterizada por baixa massa óssea e deterioração da microarquitetura do tecido ósseo, resultando em maior fragilidade e risco de fraturas, especialmente em vértebras, quadril e punho.
            </p>
          </div>
          <div className="bg-background/50 border border-border rounded-xl p-8">
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-gold/15 text-gold mb-4">
            ...
            <p className="font-body text-foreground/65 leading-relaxed text-sm">
              Síndrome musculoesquelética progressiva caracterizada por redução da massa muscular esquelética associada a diminuição da força muscular e/ou da função física, especialmente em idosos.
            </p>
          </div>
        </div>
